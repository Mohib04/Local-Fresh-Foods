        ...
        <div id="md_en" class="agreement_md" data-target="out_en">
            <div class="mx-auto" style="width: 90%; margin-left: ($spacer * .25) !important; padding: 50px;">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong>&nbsp;(referred to as either &ldquo;the Company&rdquo;,
                            &ldquo;We&rdquo;, &ldquo;Us&rdquo; or &ldquo;Our&rdquo; in this Agreement) refers to
                            localfreshfoods.co.uk.</p>
                    </li>
                    <li>
                        <p><strong>Affiliate</strong>&nbsp;means an entity that controls, is controlled by or is under
                            common control with a party, where &ldquo;control&rdquo; means ownership of 50% or more of
                    ...
                    <li>
                        <p><strong>Website</strong>&nbsp;refers to localfreshfoods.co.uk, accessible from&nbsp;<a
                                href="https://localfreshfoods.co.uk/" target="_blank"
                                rel="external nofollow noopener">https://localfreshfoods.co.uk/</a></p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Third-party Social Media Service</strong>&nbsp;refers to any website or any social
                            network website through which a User can log in or create an account to use the Service.</p>
                    </li>
                    <li>
                ...
                <p>Usage Data may include information such as Your Device&rsquo;s Internet Protocol address (e.g. IP
                ...
                <p>If You decide to register through or otherwise grant us access to a Third-Party Social Media Service,
                    ...
                    Service&rsquo;s account, such as Your name, Your email address, Your activities or Your contact list
                ...
                <p>You may also have the option of sharing additional information with the Company through Your
                    Third-Party Social Media Service&rsquo;s account. If You choose to provide such information and
                ...
                <p>You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent.
                    However, if You do not accept Cookies, You may not be able to use some parts of our Service.</p>
                <p>Cookies can be &ldquo;Persistent&rdquo; or &ldquo;Session&rdquo; Cookies. Persistent Cookies remain
                    on your personal computer or mobile device when You go offline, while Session Cookies are deleted as
                    soon as You close your web browser. Learn more about cookies:&nbsp;<a
                        href="https://www.termsfeed.com/blog/cookies/" target="_blank" rel="noopener">All About
                        Cookies</a>.</p>
                ...
                <ul>
                    ...
                    <li><strong>To manage Your Account:</strong>&nbsp;to manage Your registration as a user of the
                        Service. The Personal Data You provide can give You access to different functionalities of the
                    ...
                    <li><strong>To contact You:</strong>&nbsp;To contact You by email, telephone calls, SMS, or other
                        equivalent forms of electronic communication, such as a mobile application&rsquo;s push
                ...
                <ul>
                    ...
                    <li><strong>With other users:</strong>&nbsp;when You share personal information or otherwise
                        interact in the public areas with other users, such information may be viewed by all users and
                        may be publicly distributed outside. If You interact with other users or register through a
                        Third-Party Social Media Service, Your contacts on the Third-Party Social Media Service may see
                        Your name, profile, pictures and description of Your activity. Similarly, other users will be
                        able to view descriptions of Your activity, communicate with You and view Your profile.</li>
                </ul>
                ...
                <p>Your information, including Personal Data, is processed at the Company&rsquo;s operating offices and
                ...
                <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third
                    party link, You will be directed to that third party&rsquo;s site. We strongly advise You to review
                ...
                <p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming
                    effective and update the &ldquo;Last updated&rdquo; date at the top of this Privacy Policy.</p>
                ...
                <p><strong>Local Fresh Foods</strong></p>
                39 Harris Close,<br />Kelly Bray,<br />Callington<br />CORNWALL<br />PL17 8QT<br />
                <p>Tel: 01579 383 571</p>
                <p>By email:&nbsp;admin@localfreshfoods.co.uk</p>
...
<footer>
    <div class="container">Privacy Policy for localfreshfoods.co.uk</div>
</footer>
